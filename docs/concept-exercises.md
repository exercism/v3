...
- The hints can use code samples to explain concepts, but not to outline the solution. For example, in a lists exercise they might show a snippet of how a certain list function works, but in a way that is not directly copy/pasteable into the solution.
