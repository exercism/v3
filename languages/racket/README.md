...
Welcome to the workspace for Exercism v3's Racket track!

This area will contain everything needed to launch the Racket track, including:

- The new exercises and `config.json` file.
- Reference documentation that help explain Racket concepts for which no appropriate online document could be found.
- Racket-specific documentation for contributors.
