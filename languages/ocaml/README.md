...
Welcome to the workspace for Exercism v3's OCaml track!

This area will contain everything needed to launch the OCaml track, including:

- The new exercises and `config.json` file.
- Reference documentation that help explain OCaml concepts for which no appropriate online document could be found.
- OCaml-specific documentation for contributors.
