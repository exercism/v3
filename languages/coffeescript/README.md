...
Welcome to the workspace for Exercism v3's CoffeeScript track!

This area will contain everything needed to launch the CoffeeScript track, including:

- The new exercises and `config.json` file.
- Reference documentation that help explain CoffeeScript concepts for which no appropriate online document could be found.
- CoffeeScript-specific documentation for contributors.
