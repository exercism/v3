...
Welcome to the workspace for Exercism v3's Bash track!

This area will contain everything needed to launch the Bash track, including:

- The new exercises and `config.json` file.
- Reference documentation that help explain Bash concepts for which no appropriate online document could be found.
- Bash-specific documentation for contributors.
