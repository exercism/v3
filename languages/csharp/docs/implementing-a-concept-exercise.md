...
Some exercises could benefit from having a custom representation as generated by the [C# representer][csharp-representer]. If so, specify what changes to the representation should be applied and why.
