...
- conditionals-ternary [_(conditionals-ternary)_][exercise-conditionals-ternary] - [Design][design-conditionals-ternary], [Background][tnc-conditionals-ternary]
...
- operator-overload [_(operator-overload)_][exercise-operator-overload] - [Design][design-operator-overload]
...
- signed-integers [_(signed-integers)_][exercise-signed-integers] - [Design][design-signed-integers]
- state [_(classes)_][exercise-classes] - [Design][design-classes], [Background][tnc-state]
- string-builder [_(string-formatting)_][exercise-string-formatting] - [Design][design-string-formatting]
...
- unsigned-integers [_(signed-integers)_][exercise-signed-integers] - [Design][design-signed-integers]
...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `arrays`                    | <ul><li>know xx of the existence of the `Array` type<li>know how to define an array<li>know how to access elements in an array by index<li>know how to update an element in an array by index<li>know how to iterate over elements in an array<li>know of some basic functions (like finding the index of an element in an array).                                                                                                                                                                                                    |
...
[design-conditionals-ternary]: ../exercises/concept/conditionals-ternary/.meta/design.md
...
[design-operator-overload]: ../exercises/concept/operator-overload/.meta/design.md
...
[design-signed-integers]: ../exercises/concept/signed-integers/.meta/design.md
...
[exercise-conditionals-ternary]: ../exercises/concept/conditionals-ternary
...
[exercise-operator-overload]: ../exercises/concept/operator-overload
...
[exercise-signed-integers]: ../exercises/concept/signed-integers
