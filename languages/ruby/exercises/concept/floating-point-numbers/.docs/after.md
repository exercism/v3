...
To repeatedly execute logic, one can use loops. In this example the `while` loop was useful because it keeps on looping until a boolean condition evaluates to `true`.
