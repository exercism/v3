...
Welcome to the workspace for Exercism v3's Ruby track!

This area will contain everything needed to launch the Ruby track, including:

- The new exercises and `config.json` file.
- Reference documentation that help explain Ruby concepts for which no appropriate online document could be found.
- Ruby-specific documentation for contributors.
