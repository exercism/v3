...
- Why use getters and setters rather than the instance variable directly?
  - If there was a typogrpahical error (we call this "typo") in the previous example (e.g. `@ownar`), it would fail silently, potentially introducing a bug into the system.
