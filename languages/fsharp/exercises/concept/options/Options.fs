...
let newList: string list =
    failwith "Please implement the 'newList' value"

let existingList: string list =
    failwith "Please implement the 'existingList' value"
...
let countLanguages (languages: string list): int =
    failwith "Please implement the 'countLanguages' function"

let reverseList (languages: string list): string list =
    failwith "Please implement the 'reverseList' function"

let excitingList (languages: string list): bool =
    failwith "Please implement the 'excitingList' function"
