...
fn test_reviving_dead_player() {
    let level: u32 = 34;
    let dead_player = Player { health: 0, mana: Some(0), level };
...
fn test_reviving_alive_player() {
    let level: u32 = 8;
    let alive_player = Player { health: 1, mana: None, level };
...
fn test_cast_spell_with_enough_mana() {
    ...
    let level = 100;
    let mana_cost = 3;
    let mut accomplished_wizard = Player { health, mana: Some(mana), level };
    accomplished_wizard.cast_spell(mana_cost);
...
fn test_cast_spell_with_insufficient_mana() {
    ...
    let level = 22;
    let mana_cost = 3;
    let mut no_mana_wizard = Player { health, mana: Some(mana), level };
    no_mana_wizard.cast_spell(mana_cost);
...
fn test_cast_spell_with_no_mana_pool() {
    ...
    let level = 6;
    let mana_cost = 3;
    let mut underleveled_player = Player { health, mana: None, level };
