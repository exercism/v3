...
Welcome to the workspace for Exercism v3's Delphi track!

This area will contain everything needed to launch the Delphi track, including:

- The new exercises and `config.json` file.
- Reference documentation that help explain Delphi concepts for which no appropriate online document could be found.
- Delphi-specific documentation for contributors.
