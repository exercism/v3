...
Welcome to the workspace for Exercism v3's Raku track!

This area will contain everything needed to launch the Raku track, including:

- The new exercises and `config.json` file.
- Reference documentation that help explain Raku concepts for which no appropriate online document could be found.
- Raku-specific documentation for contributors.
