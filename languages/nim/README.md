...
Welcome to the workspace for Exercism v3's Nim track!

This area will contain everything needed to launch the Nim track, including:

- The new exercises and `config.json` file.
- Reference documentation that help explain Nim concepts for which no appropriate online document could be found.
- Nim-specific documentation for contributors.
