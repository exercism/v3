...
Welcome to the workspace for Exercism v3's R track!

This area will contain everything needed to launch the R track, including:

- The new exercises and `config.json` file.
- Reference documentation that help explain R concepts for which no appropriate online document could be found.
- R-specific documentation for contributors.
