...
from tuples import get_coordinate, convert_coordinate, compare_records, create_record, clean_up, multiply_records
...
class TuplesTest(unittest.TestCase):
    ...
    def test_multiply_records(self):
        input_data = (
