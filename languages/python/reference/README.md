...
| [break][keyword-break]                                                       | `general`, `keyword`                              | [#1432](https://github.com/exercism/v3/issues/1432) |                      [ ]()                      |
...
| [Comprehension Syntax][comprehension-syntax]                                 | `intermediate`                                    | [#1361 ](https://github.com/exercism/v3/issues/1361)|                  BethanyG [ ]()                 |
...
| [continue][keyword-continue]                                                 | `general`, `keyword`                              | [#1432](https://github.com/exercism/v3/issues/1432) |                      [ ]()                      |
...
| [dict][builtin-types-dict]                                                   | `basic`, `types`, `containers`                    |  [#877](https://github.com/exercism/v3/issues/877)  |             Job van der Wal []()                |
| [Dict comprehension][dict-comprehension]                                     | `intermediate`                                    | [#1376 ](https://github.com/exercism/v3/issues/1376)|             BethanyG [ ]()                      |
...
| [Exiting loops][exiting-loops]                                               | `general`                                         | [#1432](https://github.com/exercism/v3/issues/1432) |                      [ ]()                      |
...
| [list comprehension][list-comprehension]                                     | `intermediate`                                    | [#1361](https://github.com/exercism/v3/issues/1361) |            BethanyG  [ ]()                      |
...
| [Scope][scope]                                                               | `general`                                         |                        [ ]()                        |                      [ ]()                      |
| [set][builtin-types-set]                                                     | `basic` , `types`, `builtins`, `containers`       | [#1086](https://github.com/exercism/v3/issues/1086) |             BethanyG [ ]()                      |
| [Set comprehension][set-comprehension]                                       | `intermediate`                                    | [#1376 ](https://github.com/exercism/v3/issues/1376)|             BethanyG [ ]()                      |
| [slice][builtin-types-slice]                                                 | `advanced`, `types`, `builtins`, `containers`     |                        [ ]()                        |                      [ ]()                      |
| [Slicing][slicing]                                                           | `general`                                         | [#1393](https://github.com/exercism/v3/issues/1393) |             BethanyG [ ]()                      |
...
| [str][builtin-types-str]                                                     | `basic`, `types`, `builtin`                       |                        **NA**                       | [#824](https://github.com/exercism/v3/pull/824) |
